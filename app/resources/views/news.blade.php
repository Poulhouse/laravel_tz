...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
	    ...
	    <div class="relative bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
		    <div class="container-fluid max-w-6xl mx-auto sm:px-6 lg:px-8 album py-5 bg-light">
			    <div class="row mb-2">
